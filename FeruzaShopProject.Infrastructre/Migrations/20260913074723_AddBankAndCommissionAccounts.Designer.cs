...
namespace FeruzaShopProject.Infrastructre.Migrations
{
    ...
    [Migration("20260913074723_AddBankAndCommissionAccounts")]
    partial class AddBankAndCommissionAccounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FeruzaShopProject.Domain.Entities.BankAccount", b =>
                {
                    ...
                    b.HasIndex("BranchId", "AccountNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("FeruzaShopProject.Domain.Entities.CommissionAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CommissionAccounts");
                });

            modelBuilder.Entity("FeruzaShopProject.Domain.Entities.CommissionLedgerEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FeruzaShopProject.Domain.Entities.CommissionLedgerEntry", b =>
                {
                    b.HasOne("FeruzaShopProject.Domain.Entities.CommissionAccount", "CommissionAccount")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("FeruzaShopProject.Domain.Entities.CreditPayment", b =>
                {
                    b.HasOne("FeruzaShopProject.Domain.Entities.BankAccount", "BankAccount")
